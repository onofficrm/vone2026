...
<!-- 로그인 후 아웃로그인 { -->
<section id="ol_after" class="ol onoff-platform onoff-platform--outlogin">
    <header id="ol_after_hd">
        ...
        <a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>" class="btn_admin btn" title="관리자"><i class="fa fa-cog fa-spin fa-fw"></i><span class="sound_only">관리자</span></a>
        <?php } ?>
    </header>
